...
class Order(Base):
    ...
    detail = Column(String, index=True, default=None)
    created_at = Column(DateTime, index=True)
    updated_at = Column(DateTime, index=True)

    def __init__(self, client_id, engineer_id, serial_number, company_name, status, order_issue_id, description, detail, **kwargs):
